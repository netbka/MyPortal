    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EntityUserProfile", x => x.AspNetUserId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUserClaims_EntityUserProfile_UserId",
                        column: x => x.UserId,
                        principalTable: "EntityUserProfile",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUserLogins_EntityUserProfile_UserId",
                        column: x => x.UserId,
                        principalTable: "EntityUserProfile",
                        principalColumn: "AspNetUserId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AspNetUserRoles_EntityUserProfile_UserId",
                        column: x => x.UserId,
                        principalTable: "EntityUserProfile",
                        principalColumn: "AspNetUserId",
                        onDelete: ReferentialAction.Cascade);
